...
class AddMediaStateNotifier extends StateNotifier<AddMediaState> {
  AddMediaStateNotifier() : super(AddMediaState());

  // Function to add a file to the state
  void addFile(File file) {
    state = state.copyWith(files: [...state.files, file]);
  }

  // Function to add a URL to the state
  void addUrl(String url) {
    state = state.copyWith(urls: [...state.urls, url]);
  }
}
// Define the StateNotifierProvider
final addMediaStateProvider =
    StateNotifierProvider<AddMediaStateNotifier, AddMediaState>(
  (ref) => AddMediaStateNotifier(),
);
